        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>Asistencia {COMPANY_INFO.guarantees.support}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t pt-8">
          ...
          <div className="flex justify-center gap-6 mb-6">
            <Link
              ...
              className="group p-3 rounded-full bg-gray-100 hover:bg-blue-600 transition-all duration-300"
              aria-label="Facebook"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-3 rounded-full bg-gray-100 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 transition-all duration-300"
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-3 rounded-full bg-gray-100 hover:bg-black transition-all duration-300"
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-3 rounded-full bg-gray-100 hover:bg-blue-700 transition-all duration-300"
              aria-label="LinkedIn"
            >
              <svg className="w-5 h-5 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
